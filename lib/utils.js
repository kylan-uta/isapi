define(function (require, exports, module) {
    ...
    require("./encryption/AES"), e.prototype = {
        ...
        decodeAES: function (encryptedValue, aesKey, iv, i) {
            var a = "";
            if ("ecb" === i)
                for (var o = encryptedValue.length, r = 0; o > 0;) a += o > 32 ? aes_decrypt(encryptedValue.substring(r, r + 32), aesKey, !1) : aes_decrypt(encryptedValue.substring(r), aesKey, !1), o -= 32, r += 32;
            else {
                iv === void 0 && (iv = "6cd9616beb39d4034fdebe107df9a399");
                console.log('AESKEY:', aesKey, 'IV', iv, 'ENCVAL', encryptedValue);
                var s = CryptoJS.enc.Hex.parse(aesKey),
                    l = CryptoJS.enc.Hex.parse(iv),
                    c = CryptoJS.enc.Hex.parse(encryptedValue),
